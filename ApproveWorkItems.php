...
<div class="main">
    ...
    <thead>
      <tr>
        ...
        <th>Approve 
            select all :<br/>
            <input type="checkbox" name="allCheck" onClick="selectallMe()" class="largeCheckBox">
        </th>
      </tr>
    </thead>
    <tbody>
    ...
    <?php endwhile;?>
    <tr >
        <td><button type="submit" class="btn" name="approve" onclick="GetSelected()">Submit</button></td>
    </tr>
